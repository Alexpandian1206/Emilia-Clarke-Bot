...
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v1.0.1 [ 𝙱𝙴𝚃𝙰 ]"""
    SOURCE_TXT = """<b>NOTE:</b>
- Emilia Clarke is an open source project. 
- Source - https://github.com/Alex27ak/Main_Source  

<b>DEVS:</b>
- <a href=https://github.com/Alex27ak/Main_Source</a>"""
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and Emilia Clarke will respond whenever that keyword hits the message
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/Aklinksz)</code>
